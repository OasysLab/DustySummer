...
#define SSID "Jaikoh's iPhone";
#define password "Tjk28212821";
#define DST_IP "202.28.24.69"
...
void senddata()
{
   String cmd = "AT+CIPSTART=\"TCP\",\"";
     ...
     cmd += String(hum_act)+"&";
     cmd += "P=";
     cmd += String(press_act)+"&";
     cmd += "P101=";
     cmd += String(PM10Value[0])+"&";
     cmd += "P102=";
     cmd += String(PM10Value[1])+"&";
     cmd += "P103=";
     cmd += String(PM10Value[2])+"&";
     cmd += "P251=";
     cmd += String(PM2_5Value[0])+"&";
     cmd += "P252=";
     cmd += String(PM2_5Value[1])+"&";
     cmd += "P253=";
     cmd += String(PM2_5Value[2])+"&";
     cmd += "P11=";
     cmd += String(PM01Value[0])+"&";
     cmd += "P12=";
     cmd += String(PM01Value[1])+"&";
     cmd += "P13=";
     cmd += String(PM01Value[2]);
     cmd += "\r\n\r\n";
